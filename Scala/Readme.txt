...
The dataset comprises of three csv files, namely user.csv,

business.csv and review.csv.
...
system or the cluster. (Very important) command : spark-shell --master local[*]
